...
public static class Config {
    public static List<TimeData> timeTypes = new List<TimeData> ();

    public static List<OutTimeData> timeReorder = new List<OutTimeData> ();
    ...
    public static void saveConfig () {
        ...
        Properties.Settings.Default.User = name;
